...
Por que nao utilizar o strategy? -> Mesmo que indicado tambem para este tipo de questão, o strategy busca a troca de algoritmos de forma dinâmica, em tempo de execução. Nao sendo este o caso do projeto para a questão 01, mas coincidentemente para a questão dois, sim!
